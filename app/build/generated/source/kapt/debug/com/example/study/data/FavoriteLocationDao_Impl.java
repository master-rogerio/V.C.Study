...
public final class FavoriteLocationDao_Impl implements FavoriteLocationDao {
  ...
  public FavoriteLocationDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfFavoriteLocation = new EntityInsertionAdapter<FavoriteLocation>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `favorite_locations` (`id`,`name`,`latitude`,`longitude`,`radius`,`iconName`,`preferredCardTypes`,`studySessionCount`,`averagePerformance`) VALUES (?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        final String _tmp = __converters.toFlashcardTypeList(entity.getPreferredCardTypes());
        if (_tmp == null) {
          statement.bindNull(7);
        } else {
          statement.bindString(7, _tmp);
        }
        statement.bindLong(8, entity.getStudySessionCount());
        statement.bindDouble(9, entity.getAveragePerformance());
      }
    };
    ...
    this.__updateAdapterOfFavoriteLocation = new EntityDeletionOrUpdateAdapter<FavoriteLocation>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `favorite_locations` SET `id` = ?,`name` = ?,`latitude` = ?,`longitude` = ?,`radius` = ?,`iconName` = ?,`preferredCardTypes` = ?,`studySessionCount` = ?,`averagePerformance` = ? WHERE `id` = ?";
      }
  ...
  public LiveData<List<FavoriteLocation>> getAllFavoriteLocations() {
    final String _sql = "SELECT `favorite_locations`.`id` AS `id`, `favorite_locations`.`name` AS `name`, `favorite_locations`.`latitude` AS `latitude`, `favorite_locations`.`longitude` AS `longitude`, `favorite_locations`.`radius` AS `radius`, `favorite_locations`.`iconName` AS `iconName`, `favorite_locations`.`preferredCardTypes` AS `preferredCardTypes`, `favorite_locations`.`studySessionCount` AS `studySessionCount`, `favorite_locations`.`averagePerformance` AS `averagePerformance` FROM favorite_locations";
    ...
    return __db.getInvalidationTracker().createLiveData(new String[] {"favorite_locations"}, false, new Callable<List<FavoriteLocation>>() {
      ...
      public List<FavoriteLocation> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfRadius = 4;
          final int _cursorIndexOfIconName = 5;
          final int _cursorIndexOfPreferredCardTypes = 6;
          final int _cursorIndexOfStudySessionCount = 7;
          final int _cursorIndexOfAveragePerformance = 8;
          ...
          while (_cursor.moveToNext()) {
            ...
            if (_cursor.isNull(_cursorIndexOfPreferredCardTypes)) {
              ...
              _tmp = _cursor.getString(_cursorIndexOfPreferredCardTypes);
            }
            _tmpPreferredCardTypes = __converters.fromFlashcardTypeList(_tmp);
            ...
            _item = new FavoriteLocation(_tmpId,_tmpName,_tmpLatitude,_tmpLongitude,_tmpRadius,_tmpIconName,_tmpPreferredCardTypes,_tmpStudySessionCount,_tmpAveragePerformance);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public FavoriteLocation call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final double _tmpAveragePerformance;
            _tmpAveragePerformance = _cursor.getDouble(_cursorIndexOfAveragePerformance);
            _result = new FavoriteLocation(_tmpId,_tmpName,_tmpLatitude,_tmpLongitude,_tmpRadius,_tmpIconName,_tmpPreferredCardTypes,_tmpStudySessionCount,_tmpAveragePerformance);
          } else {
            _result = null;
          }
          return _result;
